...
-- FIX: ClipsDescendants = true on body — prevents content from
-- briefly showing during panel show/hide scale animation
local body = new("Frame", {
    Name = "Body", BackgroundTransparency = 1,
    Position = UDim2.new(0, 0, 0, HH), Size = UDim2.new(1, 0, 1, -HH),
    ClipsDescendants = true, ZIndex = 1,
}, panel)
